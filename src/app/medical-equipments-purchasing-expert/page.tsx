  ...
  return (
    <div className="w-full flex flex-col">
      <div className="w-full grid grid-cols-5 gap-5">
        <div className="w-full xl:col-span-4 col-span-5">
          <Box>
            <div className="w-full flex p-3 h-full">
              {counselorData?.object?.imageUrl && (
                <Image
              ...
              <div className="flex flex-col text-[16px] justify-between text-dark h-full px-4">
                ...
                <p className="text-base text-[#707070] text-[14px]">
                  {counselorData?.object?.comment}
                </p>
                <div className="flex justify-end mt-4">
                  <div className="w-[174px] flex justify-between items-center px-6 py-2 rounded-md text-primary border-2 border-primary bg-primaryLight">
                    <svg
                      width="24"
                      height="24"
                      viewBox="0 0 24 24"
        ...
        <div className="w-full xl:col-span-1 col-span-3 justify-center m-auto justify-self-center">
          <Box>
            <div className="flex flex-col justify-center items-center p-2">
              <div className="flex justify-center">
                ...
                <p className="mr-3 text-dark text-[16px]">ارتباط با کارشناس</p>
              </div>
              <div className="w-full grid grid-cols-1 gap-5 items-center mt-5">
                <ContactInput
      ...
      <div className="w-full mt-20">
        ...
        >
          <div className="w-full items-center justify-between grid grid-cols-11 mt-10">
