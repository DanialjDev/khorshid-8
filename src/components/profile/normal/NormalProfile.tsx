    ...
    <div className="w-full flex flex-col">
      ...
      <div
        className={`w-full flex flex-col ${
          selectedTab === "userInfo" ? "shadow-xs" : ""
        } rounded-[12px]`}
      >
        {/* Tabs */}
        ...
        {selectedTab === "userInfo" ? (
          ...
          <>
            ...
            <div className="w-full flex flex-col items-start border-t border-profileBorderBottom pt-5">
              <div className="flex w-full items-center">
                ...
                <p className="mr-2">
                  نشان دهنده تایید دستگاه توسط شرکت خورشید هشت می باشد و دستگاه
                  شما در سایت ثبت شده است.
                </p>
              </div>
              ...
              <div className="flex w-full items-center mb-5">
                ...
                <p className="mr-2">
                  مشخصات دستگاه شما در حال بررسی متخصصین ما می باشد.
                </p>
              </div>
            </div>
          </>
