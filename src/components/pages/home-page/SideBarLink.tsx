    ...
    <div className="w-full col-span-4 flex flex-col px-5 py-7 bg-white shadow-md rounded-xl">
      <div className="flex">
        <div>
          ...
          >
            <g filter="url(#filter0_d_133_2326)">
              <rect
                x="19.3589"
                y="19.4203"
                width="14.6989"
                height="14.6989"
                rx="2"
                transform="rotate(-45 19.3589 19.4203)"
                fill="#FCFCFC"
              />
            </g>
            <g filter="url(#filter1_d_133_2326)">
              <rect
                x="15"
                y="20.3696"
                width="13.0138"
                height="13.0138"
                rx="2"
                transform="rotate(-45 15 20.3696)"
                fill="#54E346"
              />
            </g>
            <defs>
              <filter
                id="filter0_d_133_2326"
                x="11.3589"
                y="3.02661"
                width="36.7874"
                height="36.7874"
              ...
              >
                ...
                <feColorMatrix
                  type="matrix"
                  values="0 0 0 0 0.184314 0 0 0 0 0.184314 0 0 0 0 0.184314 0 0 0 0.15 0"
                />
                <feBlend
                  mode="normal"
                  in2="BackgroundImageFix"
                  result="effect1_dropShadow_133_2326"
                />
                <feBlend
                  mode="normal"
                  in="SourceGraphic"
                  in2="effect1_dropShadow_133_2326"
                  result="shape"
                />
              </filter>
              <filter
                id="filter1_d_133_2326"
                x="0"
                y="0.167419"
                width="48.4043"
                height="48.4044"
              ...
              >
                ...
                <feColorMatrix
                  type="matrix"
                  values="0 0 0 0 0.145098 0 0 0 0 0.145098 0 0 0 0 0.133333 0 0 0 0.05 0"
                />
                <feBlend
                  mode="normal"
                  in2="BackgroundImageFix"
        ...
        <p className="xl:text-[14px] text-[12px]">
          <span className="text-secondary">ما</span> به شما بهترین مشاوره خرید
          تجهیزات پزشکی را ارائه خواهیم کرد
        </p>
      </div>
      <p className="my-7 text-gray text-[12px]">
        شما می توانید با استفاده از تجربه کارشناسان ما در خرید لوازم و تجهیزات
        پزشکی خود به بهترین گزینه ها برسید.
      </p>
      <div className="mt-6">
        <Button
          onClick={() => {
